...
export class Config {
	...
	static loaderText = {
		es: ["TheMarceloYT estuvo aquí...", "¿Scorpion o Sub-Zero?...", "¡Toasty!...", "Descomprimiendo el reino..."],
		en: ["TheMarceloYT was here...", "¿Scorpion or Sub-Zero?...", "¡Toasty!...", "Unpacking the realm..."],
	};
