...
export class DataBase {
  ...
  static translationTextos = {
    es: {
      ...
      langDescNueve:
        "Implementación propia de soporte multilenguaje y personalización de temas.",
      /* ABOUT [FIN] */
    ...
    en: {
      ...
      langDescNueve:
        "Own implementation of multilingual support and theme customization.",
      /* ABOUT [FIN] */
  ...
  static proyectosSection = {
    ...
    globi: {
      ...
      sourceHerramientas: "/assets/images/herramientas/",
      sourceCodeLink:
        "https://github.com/TheMarceloYT/appEventosFlutter_flutter",
      privacy: "public",
    },
    autogestor: {
      ...
      sourceHerramientas: "/assets/images/herramientas/",
      sourceCodeLink:
        "https://github.com/TheMarceloYT/appTallerDeVehiculos_NetBeans",
      privacy: "public",
    },
    taskflow: {
      id: "projectTaskFlow",
